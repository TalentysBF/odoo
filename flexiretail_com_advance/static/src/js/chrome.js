...
//        	    $(this).find('i').toggleClass('fa fa-chevron-down fa fa-chevron-right');
        	    if($('#toggle_image').hasClass('right')){
        	    	...
        	    	$('#toggle_image').attr('src','/flexiretail_com_advance/static/src/img/icons/angle-down.svg')
        	    }else{
        	    	$('#toggle_image').addClass('right');
        	    	$('#toggle_image').attr('src','/flexiretail_com_advance/static/src/img/icons/angle-right.png')
        	    }
        	});
        },
	});
