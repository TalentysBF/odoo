...
//	var CashierLocationsPopupWidget = PopupWidget.extend({
//	    template: 'CashierLocationsPopupWidget',
//	    show: function(options){
//	    	var self = this;
//	        options = options || {};
//	        self.cashier_locations = options.cashier_locations;
//	        self._super(options);
...
//	    			$('.location').removeClass('change_location')
//	    		}else {
//	    			$('.location').removeClass('change_location')
...
//					model: 'pos.config',
//					method: 'write',
//					args: [self.pos.config.id,{'stock_location_id':Number(self.selected_id)}],
//				}
//			if(self.selected_id){
//				rpc.query(params, {async: false}).then(function(result){
//					if(result){
//						self.pos.shop = self.pos.locations_by_id[self.selected_id];
//						self._super();
//						self.pos.db.notification('success',_t(self.pos.shop.name + ' switched successfully.'));
//					} else {
//						self.pos.db.notification('danger',_t('Could not switch to location.'));
//					}
...
//	    },
//	});
//	gui.define_popup({name:'cashier_locations_popup', widget: CashierLocationsPopupWidget});
    ...
    var PackLotLinePopupWidget = PopupWidget.extend({
	    ...
	    render_list: function(orders){
            ...
            for(var i = 0, len = Math.min(orders.length,1000); i < len; i++){
                ...
                serial.check_serial_life =moment(serial.life_date).format('YYYY/MM/DD');
